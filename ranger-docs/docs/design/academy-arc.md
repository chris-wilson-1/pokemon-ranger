...
Act 1 does one job: **earn the warmth.** Everything here has to feel genuinely good on first play. No foreshadowing winks to camera. No unease. The player bonds with their home, their mum, their mentor, their friend, their rival, and their Foundation-gifted starter — and then leaves, whole and happy, for their first outward posting.
...
- **Central pond** with a Surf-gated item on the far side. Classic come-back-later hook. Revisiting post-Surf walks the player through the town after the turn — the desaturated home is one of act 3's quiet gut-punches.
- **Town square / open area** near the academy where the rival fight and the CEO speech both stage.
- No shop, no Pokémon Center, no infirmary, no gym.

**Exits:**

- **South** — short path to the train station. The train goes north to the Quarry (Beat 9 — board and depart). Walking *past* the train station southward leads toward the abandoned tail (stations 2 and 1 — retirement village and Eternal Tree). The player cannot go south in act 1 — the tail is visited late — but the direction is geographically available and the player can see the path exists.
- **North / east / west** — blocked by pond, trees, fence, or terrain. The player cannot walk overland to the Quarry; the train is the only way north.

### The academy interior

Two floors. Significant building, as befits a Ranger Corps institution.
...
- **Matthias "Matty"** — the quartermaster. Academy ground floor. Hands out the starter pack. Foundation logo on the first-aid kit and other gear. **Young — mid-20s — athletic, casually warm, the kind of senior ranger the new recruits want to impress.** Recently inherited the quartermaster role from an older predecessor whose voice he still quotes naturally without thinking about it. Beloved by the recruits. The specific shape of Matty's compartmentalisation is TBD, but his **generationally inherited stylus-era phrase** (see Beat 3) is the load-bearing omission — he is unknowingly carrying a lost tradition forward by repeating something his grandfather used to say.
...
The opening arc from new game to boarding the train. 10 beats. Act 1's warmth must be unbroken; no beat here may foreshadow with a wink.
...
Walk into the academy lobby. **Cassian** at the open desk greets the player by name. **Matty** (the quartermaster) hands out the starter pack — **the first-aid kit has the Thorne Foundation logo on it.** This is the first Foundation legitimacy beat; it is delivered through a kind gift and will not register as foreshadowing. **Bran** is already there being smug. Ambient rangers are present. Cassian sends the new graduates upstairs to the classroom for the ceremony.

**Soft stylus seed (Matty, one line, easily missed).** When Matty hands over the balls in the starter pack, he delivers a brief **inherited phrase** — something in the shape of *"my granddad always called these the best tools we've got — said they'd do you right as well as anything they used in his day"* or *"old man used to say these were as good as anything he'd trained on when he was starting out"* — delivered without emphasis, no reaction-beat afterward, no dialogue branch unlocking, no explanation of who the granddad/old man was. **Because Matty is young (mid-20s), the seed is not a personal memory — it's a generationally-inherited phrase he is casually quoting without thinking about what it actually references.** In act 1 it reads as affectionate family flavour — the kind of thing a young ranger says because his grandfather used to say it, warm and slightly self-deprecating. In act 3 it is one of the two places the player can go back to and hear what was always there: the lost tradition is **two generations back**, carried forward through a young man's mouth who doesn't know he's doing archaeology. **Do not let Matty explain who "Granddad" or "the old man" was.** Omission only per craft commitment #5 — the seed works precisely because Matty himself doesn't know what he's referring to.
