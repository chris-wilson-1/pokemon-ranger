...
**Soft stylus seed (Matty, one line, easily missed).** When Matty hands over the balls in the starter pack, he has a brief wistful half-beat — something in the shape of *"best tools we've got now"* or *"these'll do you right, as well as anything we'd have used in my day"* — delivered without emphasis, no reaction-beat afterward, no dialogue branch unlocking. In act 1 it reads as rugged-old-quartermaster flavour; in act 3 it is one of the two places the player can go back to and hear what was always there. **Do not let Matty explain anything.** Omission only per craft commitment #5.
