...
The region the hack takes place in. Drafted 2026-04-07 in the brainstorming session that locked the [story spine](story.md). Many specifics (station names, biome layout, the Company's name, the Eternal Tree's exact location) are still open and called out at the bottom.
...
If Xerneas is the wound, the climactic question is not "stop the Company." It is **whether to wake the Tree.**

- Waking Xerneas means the Company's manufactured ecology — the one Pokémon and humans across Ardenna now depend on — does not survive contact with the original.
- Not waking Xerneas means the river continues to die, the Company continues to win, the manufactured ecology continues to spread.
...
- The player has to choose. The game does not soften the choice.

This is the ending the [story spine](story.md) has been building toward.
...
- **Rank progression.** Roughly one rank per station outward from the academy is a natural fit, but TBD until station identities are decided.
...
These belong in [open questions](../reference/open-questions.md):

- Exact station count (7 vs 8) and the identity of each station
- Biome layout along the spine
- The Company's name and visual identity (logo, colour, typography)
- The Eternal Tree's exact location — tail terminus, hidden, or in plain sight?
- Whether the finale is staged at the terminus or pulls back to the tail
- The mentor character (probably wants its own brainstorming session)
- The 2–3 ex-ranger cell members
- Which specific Pokémon species are the visible victims at extraction sites
- Which species "left during the Withdrawal" and are absent from the regional dex
- Tile/encounter art direction for the river degradation

## When we'll decide the rest

After the tech demo proves the build → edit → test loop is comfortable. Setting decisions are downstream of:

1. Knowing how much map work we can realistically scope
2. Knowing whether we're confident enough with tilesets to build custom areas
3. Story milestones being detailed enough to know what each station needs to *do*
